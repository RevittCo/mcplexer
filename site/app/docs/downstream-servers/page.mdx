...
<PropTable props={[
  ...
  { name: "discovery", type: "\"static\" | \"dynamic\"", default: "\"dynamic\"", description: "How tools are discovered — cached on startup (static) or queried at runtime (dynamic)" },
...
<Callout type="info" title="Codex compatibility">
