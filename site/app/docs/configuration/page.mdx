...
<PropTable props={[
  ...
  { name: "MCPLEXER_SLIM_TOOLS", type: "bool", default: "true", description: "Minify tool schemas to reduce AI context window consumption." },
  { name: "MCPLEXER_CODEX_DYNAMIC_TOOL_COMPAT", type: "bool", default: "true", description: "Auto-include dynamic-discovery tools in tools/list for Codex client sessions." },
