...
<PropTable props={[
  ...
  { name: "--addr", type: "string", default: "127.0.0.1:8080", description: "Listen address for HTTP mode." },
...
<PropTable props={[
  { name: "MCPLEXER_CONTROL_READONLY", type: "env var", default: "true", description: "When true, the control server only exposes read operations." },
]} />
